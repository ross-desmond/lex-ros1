...
using AudioTextConversation = lex_common_msgs::AudioTextConversation;
...
AudioTextConversation::Response& operator<<(lex_common_msgs::AudioTextConversationResponse& ros_response,
